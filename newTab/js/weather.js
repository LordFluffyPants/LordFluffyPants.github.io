var json_url = "http://api.openweathermap.org/data/2.5/weather?q=Annandale,ma&appid=6e131a2916d5d45d8367b72a4675be0a";
var city;
var temp_curr;
var temp_low;
var temp_high;
...
function insertWeatherInfo() {
	//$("#city").append(city);
	$("#description").append("The weather is "+description + " and the current temperature is " + temp_curr + "&deg;");
